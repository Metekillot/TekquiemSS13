...
#define JOB_UNAVAILABLE_FACTION 7
#define JOB_UNAVAILABLE_MASQUERADE 8
#define JOB_UNAVAILABLE_SPECIES 9
#define JOB_UNAVAILABLE_ENDORSEMENT 10
#define JOB_UNAVAILABLE_SPECIES_LIMITED 11
#define JOB_UNAVAILABLE_CLAN 12
#define JOB_UNAVAILABLE_AGE 13
